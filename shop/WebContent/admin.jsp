            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="adminlogin.jsp">管理系统</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="latest-product">
                        <h2 class="section-title">管理系统</h2>
                        <div id="myform">
                            <a href="<%=basePath%>admin/users">用户列表</a>
                            <a href="<%=basePath%>admin/orders">订单管理</a>
                            <a href="<%=basePath%>admin/products">商品管理</a>
                            <a href="<%=basePath%>admin/category">类别管理</a>
                        </div>
                    </div>
                </div>
            </div>
