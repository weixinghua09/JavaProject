                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="login.html"><i class="fa fa-user"></i> ${user.userName }</a></li>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="checkout.html">收货地址</a></li>
                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            <form enctype="multipart/form-data" action="<%=basePath %>address/updateaddress" class="checkout" method="post" name="checkout">
                                    ...
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <p id="billing_country_field" class="form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                                                <label for="billing_country">国家<abbr title="required" class="required">*</abbr>
                                                </label>
                                            ...
                                            <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                                <label class="" for="billing_first_name">收货人 <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="${address.name }" placeholder="" id="billing_first_name" name="name" class="input-text ">
                                            </p>
                                            <p id="billing_city_field" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
                                                <label class="" for="billing_city">省份 <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="${address.province }" placeholder="Town / City" id="billing_city" name="province" class="input-text ">
                                            </p>
                                            <p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
                                                <label class="" for="billing_state">县/市</label>
                                                <input type="text" id="billing_state" name="city" placeholder="State / County" value="${address.city }" class="input-text ">
                                            </p>
                                            <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                <label class="" for="billing_address_1">地址<abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="${address.destination }" placeholder="Street address" id="billing_address_1" name="destination" class="input-text ">
                                            </p>
                                            <p id="billing_postcode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                                <label class="" for="billing_postcode">邮政编码 <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="${address.postcode }" placeholder="Postcode / Zip" id="billing_postcode" name="postcode" class="input-text ">
                                            </p>
                                            <div class="clear"></div>
                                            <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                                                <label class="" for="billing_phone">联系方式<abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="${address.phone }" placeholder="" id="billing_phone" name="phone" class="input-text ">
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <input type="submit" value="保存" name="save" class="checkout-button button alt wc-forward">
                            </form>
                        </div>                       
                    </div>                    
                </div>
