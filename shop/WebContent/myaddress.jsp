                                ...
                                <table cellspacing="0" class="shop_table cart">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-remove">&nbsp;</th>
                                            <th class="product-thumbnail">收货人</th>
                                            <th class="product-name">地址</th>
                                            <th class="product-price">目的地</th>
                                            <th class="product-quantity">邮编</th>
                                            <th class="product-subtotal">电话</th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        <tr class="cart_item">
                                            <td class="product-remove">
                                                <a title="Remove this item" class="remove" href="<%=basePath%>address/editaddress?id=${i.id}">修改</a>
                                                <a title="Remove this item" class="remove" href="<%=basePath%>address/deleteaddress?id=${i.id}">删除</a> 
                                            </td>
                                            ...
                                            <td class="product-name">
                                               <a href="single-product.html">${i.country }<span>&nbsp;</span>${i.province }<span>&nbsp;</span>${i.city }</a>
                                            </td>

                                            <td class="product-price">
                                                <span class="amount">${i.destination }</span> 
                                            </td>

                                            <td class="product-quantity">
                                                <span class="amount">${i.postcode }</span> 
                                            </td>
                                            <td class="product-subtotal">
                                                <span class="amount">${i.phone }</span> 
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
