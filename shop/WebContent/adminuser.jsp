                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="admin.jsp"><i class="fa fa-user"></i> ${admin.adminName }</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="index.jsp">e<span>电子商店</span></a></h1>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li  class="active"><a href="adminuser.jsp">用户管理</a></li>
                        <li><a href="#">其他</a></li>
                    </ul>
                </div>  
            </div>
                                ...
                                <table cellspacing="0" class="shop_table cart">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-name">邮箱</th>
                                            <th class="product-price">年龄</th>
                                    ...
                                    <tbody>
                                        <tr class="cart_item">
                                            <td class="product-remove">
                                                <a title="Remove this item" class="remove" href="<%=basePath%>user/delete?id=${i.id}">删除</a>
                                            </td>
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="single-product.html">${i.userName}</a>
                                            </td>

                                            <td class="product-name">
                                               <a href="single-product.html">${i.email}</a>
                                            </td>

                                            <td class="product-price">
                                                <span class="amount">${i.age }</span> 
                                            </td>
